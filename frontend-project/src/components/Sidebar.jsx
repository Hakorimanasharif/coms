...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-30 w-64 bg-slate-900 text-white
          transform transition-transform duration-200 ease-in-out
          lg:translate-x-0
          ${open ? 'translate-x-0' : '-translate-x-full'}
          h-full lg:h-screen overflow-y-auto
        `}
      >
        ...
        <div className="flex flex-col h-[calc(100%-4rem)]">
          ...
          <div className="p-4 border-t border-slate-700 shrink-0">
            <p className="text-xs text-slate-500">DAB Enterprise Ltd</p>
            <p className="text-xs text-slate-600">Kigali, Rwanda</p>
          </div>
        </div>
      </aside>
    </>
